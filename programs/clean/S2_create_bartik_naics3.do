...
**(2)**
*******
*2: construct 2019 3-digit industry by 2-digit occuaption employment share:
...
*merging total employment by industry data
...
save "$data/bartik/bartik_naics3.dta", replace
